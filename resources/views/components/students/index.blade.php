<div x-data="{
        currentView: 'classes', // 'classes' or 'student-roster'
        selectedClass: {
            grade: 'Grade 4 – Rizal',
            subject: 'Science',
            students: 32,
        ...
        selectClass(item) {
            ...
            this.currentView = 'student-roster';
        }
     }"
    ...
    <!-- ============================================================ -->
    <!-- PAGE 1 — CLASS SELECTION FOR STUDENTS VIEW -->
    <!-- ============================================================ -->
    <div x-show="currentView === 'classes'" 
        ...
        <!-- Header Banner with Soft Children SVG Illustration -->
        <div class="bg-white dark:bg-[#111C38] border border-[#E5ECEB] dark:border-slate-800 rounded-3xl p-6 md:p-8 flex items-center justify-between shadow-2xs relative overflow-hidden">
            <div class="z-10 max-w-xl">
                ...
                <p class="text-xs md:text-sm text-[#64748B] dark:text-slate-400 font-medium mt-2 leading-relaxed">
                    Choose a class to view your students.
                </p>
            </div>

            <!-- Soft Children SVG Illustration matching image -->
            <div class="hidden sm:block w-28 h-20 text-[#159A9C]/40 dark:text-teal-400/40 z-10 shrink-0">
                <svg viewBox="0 0 120 80" fill="none" class="w-full h-full">
                    <!-- Classroom Board backdrop -->
                    <rect x="25" y="15" width="70" height="40" rx="6" fill="#DDF6EF" class="dark:opacity-30"/>
                    <!-- Student 1 -->
                    <circle cx="42" cy="50" r="10" fill="#FFF4D6"/>
                    <path d="M32 68 C32 58 52 58 52 68 Z" fill="#159A9C"/>
                    <!-- Student 2 -->
                    <circle cx="60" cy="46" r="11" fill="#EEE9FF"/>
                    <path d="M49 68 C49 56 71 56 71 68 Z" fill="#7C3AED"/>
                    <!-- Student 3 -->
                    <circle cx="78" cy="50" r="10" fill="#FDE9E7"/>
                    <path d="M68 68 C68 58 88 58 88 68 Z" fill="#E11D48"/>
                </svg>
            </div>
        </div>
        ...
        <div>
            <div class="flex items-center justify-between mb-5">
                ...
                <span class="text-xs font-semibold text-[#64748B] dark:text-slate-400">Select a class to manage student roster</span>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                
                <!-- Class 1: Grade 4 - Rizal -->
                <x-students.class-card @click="selectClass(classes[0])"
                                       grade="Grade 4 – Rizal"
                                       subject="Science"
                                       :studentsCount="32"
                                       iconBg="bg-[#DDF6EF] dark:bg-[#159A9C]/20"
                ...
                </x-students.class-card>

                <!-- Class 2: Grade 5 - Bonifacio -->
                <x-students.class-card @click="selectClass(classes[1])"
                                       grade="Grade 5 – Bonifacio"
                                       subject="Mathematics"
                                       :studentsCount="28"
                                       iconBg="bg-[#EEE9FF] dark:bg-purple-950/30"
                ...
                <x-students.class-card @click="selectClass(classes[2])"
                                       grade="Grade 3 – Mabini"
                                       subject="English"
                                       :studentsCount="26"
                                       iconBg="bg-[#FFF4D6] dark:bg-amber-950/30"
                ...
                <x-students.class-card @click="selectClass(classes[3])"
                                       grade="Grade 6 – Luna"
                                       subject="Araling Panlipunan"
                                       :studentsCount="30"
                                       iconBg="bg-[#FDE9E7] dark:bg-rose-950/30"
                ...
                <x-students.class-card @click="selectClass(classes[4])"
                                       grade="Grade 4 – Aguinaldo"
                                       subject="English"
                                       :studentsCount="29"
                                       iconBg="bg-[#EAF2FF] dark:bg-blue-950/30"
                        ...
                        <div class="flex items-center gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-[#64748B] dark:text-slate-400 font-medium mt-1 leading-snug">
                                    Add a new class and start managing your students.
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <!-- ============================================================ -->
    <!-- PAGE 2 — STUDENT ROSTER VIEW -->
    <!-- ============================================================ -->
    <div x-show="currentView === 'student-roster'"
         x-transition:enter="transition ease-out duration-200"
         x-transition:enter-start="opacity-0 translate-y-1"
         x-transition:enter-end="opacity-100 translate-y-0"
         style="display: none;">
        
        <x-students.student-roster />

    </div>

    <!-- Modals & Drawers -->
    <x-students.student-profile-modal />
    <x-students.add-student-modal />
    <x-students.import-students-modal />
